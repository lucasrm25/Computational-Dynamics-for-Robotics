...
% *************************************************************************
% ToDo:                                                                  
% Replace the XYZ with the appropriate terms to add a gravity compensating
% feedforward term to the compuation of the joint torques tau:
% *************************************************************************
            tau = XYZ + P*(q_des_-q_) + D*(d_q_des_-d_q_);
        case 'CompTorques'
% *************************************************************************
% ToDo:                                                                  
% Replace the XYZ with the appropriate terms to add a complete feedforward
% term that compensates for gravitational, as well as inertial forces.
% This is called the method of 'computed torques' and is essentially a
% complete inversion of the forward dynamics:
% *************************************************************************
            tau = XYZ + P*(q_des_-q_) + D*(d_q_des_-d_q_);
        otherwise
            tau = zeros(n_q, 1);
