...
% *************************************************************************
% ToDo:                                                                  
% Rename file to "BetterCoSysCLASS.m" since for matlab class names and file
...
% *************************************************************************
% ToDo:                                                                  
% Complete the code below to compute the contribution of this body to M and
% f (g is essentially what was done in Problem 32 and is hence already
% filled).  In a second step, we add all the contributions from the
% successor bodies of all child joints and return these summed terms to the
% calling function.
% *************************************************************************
            M = ;  
            f = ;
