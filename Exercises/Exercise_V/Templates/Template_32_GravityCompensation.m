...
% *************************************************************************
% ToDo:                                                                  
% Complete the code that interatively generates the 'g'-term by summing
% over the 'g'-terms generated for each individual body.  Here the current
% body (the i-th body) is stored in the variable 'B', so it's properties
% can be accessed, for example as B.m_B (for the body's mass):
% *************************************************************************
        g = g + ;
