...
% *************************************************************************
% ToDo:                                                                  
% Complete constructor here to store the transformation with respect to
% the inertial (env) frame to learn how to implement transformations in
% Matlab:
% *************************************************************************
                obj.A_IC = ;
            end
...
% *************************************************************************
% ToDo:                                                                  
% Complete the code for the set and get functions below to learn how to
% implement coordinate transformations in Matlab: 
% *************************************************************************
