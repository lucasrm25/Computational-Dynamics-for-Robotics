...
% *************************************************************************
% ToDo:                                                                  
% Complete the computation of the velocity and acceleration of the Ds
% system based on the motion of the Dp system and the displacement/
% velocity/ acceleration acceleration accross the joint:
% *************************************************************************
            Ds_omega_Ds     = ;
            Ds_v_Ds         = ;
            Ds_omegaDot_Ds  = ;
