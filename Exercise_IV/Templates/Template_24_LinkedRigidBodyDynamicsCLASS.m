    ...
    methods
        ...
        function recursiveForwardKinematics(obj, B_r_IB, A_IB)
            ...
            if obj.isLeaf == false
                ...
                % *************************************************************************
                % ToDo:                                                                  
                % Add the necessary code to recursively call the
                % 'recursiveForwardKinematics' function of all child joints to better
                % understand how the recursion works.  Make sure you understand which
                % object and function to call.  How does this chain of function calls
                % continue?
                % *************************************************************************
                for i=1:obj.nChildren
                end
