...
function ShowInertia(I, m, Type)
    ...
    switch Type
        ...
        %  centered on the faces of a cuboid. 
            ...
            % in its columns:
            x = sqrt(1.5/m*(- I1 + I2 + I3));
            y = sqrt(1.5/m*(+ I1 - I2 + I3));
            z = sqrt(1.5/m*(+ I1 + I2 - I3));
            pos = [-x,+x, 0, 0, 0, 0;
                    0, 0,-y,+y, 0, 0;
                    0, 0, 0, 0,-z,+z];
            pos = V*pos;
        ...
        % inertia I and is centered at the COG position [0;0;0].
            ...
            a = 2*sqrt(2.5/m*(- I1 + I2 + I3));
            b = 2*sqrt(2.5/m*(+ I1 - I2 + I3));
            c = 2*sqrt(2.5/m*(+ I1 + I2 - I3));
            a1 = V*[a;0;0];
            a2 = V*[0;b;0];
            a3 = V*[0;0;c];
